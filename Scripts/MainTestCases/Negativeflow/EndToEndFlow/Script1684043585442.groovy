...
WebUI.callTestCase(findTestCase('Test Cases/WorkflowTestCases/OptionalFields'),[('fileType'):fileType,('location'):location,
	('address'):address],FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Test Cases/NegativeFlow/SubmitNegativeFlowForm'),[:],FailureHandling.STOP_ON_FAILURE)
